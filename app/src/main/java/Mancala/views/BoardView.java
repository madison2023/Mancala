...
public class BoardView extends SurfaceView {
    ...
    float boardOuterLeft = 100.0f;
    float boardInnerLeft = 110.0f;
    float boardOuterRight = 1900.0f;
    float boardInnerRight = 1890.0f;
    float boardOuterTop = 200.0f;
    float boardInnerTop = 210.0f;
    float boardOuterBottom = 685.0f;
    ...
    float cyLeftStore = ((boardOuterTop+(boardHeight/10))+boardOuterBottom-(boardHeight/10))/2;
    float cxRightStore = ((boardOuterRight-(boardWidth/45))+(boardOuterRight-boardWidth/7))/2;
    float cyRightStore = ((boardOuterTop+(boardHeight/10))+boardOuterBottom-(boardHeight/10))/2;
